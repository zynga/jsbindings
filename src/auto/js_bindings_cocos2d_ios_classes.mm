...
* Generated by "generate_js_bindings.py -c cocos2d_jsb.ini" on 2013-01-03
* Script version: v0.5
*/
...
void JSB_CCDirector_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("setViewport", JSB_CCDirector_setViewport, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
...
// Arguments: 
// Ret value: BOOL (b)
JSBool JSB_CCLayerRGBA_cascadeColor(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: BOOL (b)
JSBool JSB_CCLayerRGBA_cascadeOpacity(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: BOOL
// Ret value: void (None)
JSBool JSB_CCLayerRGBA_setCascadeColor_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	CCLayerRGBA *real = (CCLayerRGBA*) [proxy realObj];
	[real setCascadeColor:(BOOL)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}
...
// Arguments: BOOL
// Ret value: void (None)
JSBool JSB_CCLayerRGBA_setCascadeOpacity_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	CCLayerRGBA *real = (CCLayerRGBA*) [proxy realObj];
	[real setCascadeOpacity:(BOOL)arg0  ];
	JS_SET_RVAL(cx, vp, JSVAL_VOID);
	return JS_TRUE;
}
...
// Arguments: 
// Ret value: void (None)
JSBool JSB_CCLayerRGBA_updateDisplayedColor(JSContext *cx, uint32_t argc, jsval *vp) {
...
// Arguments: 
// Ret value: void (None)
JSBool JSB_CCLayerRGBA_updateDisplayedOpacity(JSContext *cx, uint32_t argc, jsval *vp) {
...
void JSB_CCLayerRGBA_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		JS_FN("opacity", JSB_CCLayerRGBA_opacity, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("cascadeColor", JSB_CCLayerRGBA_cascadeColor, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("cascadeOpacity", JSB_CCLayerRGBA_cascadeOpacity, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("color", JSB_CCLayerRGBA_color, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("displayedColor", JSB_CCLayerRGBA_displayedColor, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("displayedOpacity", JSB_CCLayerRGBA_displayedOpacity, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("doesOpacityModifyRGB", JSB_CCLayerRGBA_doesOpacityModifyRGB, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setCascadeColor", JSB_CCLayerRGBA_setCascadeColor_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setCascadeOpacity", JSB_CCLayerRGBA_setCascadeOpacity_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setColor", JSB_CCLayerRGBA_setColor_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setOpacity", JSB_CCLayerRGBA_setOpacity_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setOpacityModifyRGB", JSB_CCLayerRGBA_setOpacityModifyRGB_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("updateDisplayedColor", JSB_CCLayerRGBA_updateDisplayedColor, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("updateDisplayedOpacity", JSB_CCLayerRGBA_updateDisplayedOpacity, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FS_END
	};
	static JSFunctionSpec st_funcs[] = {
		JS_FN("create", JSB_CCLayerRGBA_node_static, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FS_END
	};
