...
* Generated by "generate_js_bindings.py -c cocos2d_jsb.ini" on 2013-01-28
* Script version: v0.5
*/
...
void JSB_CCLayerRGBA_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		JS_FN("getOpacity", JSB_CCLayerRGBA_opacity, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		...
		JS_FN("updateDisplayedColor", JSB_CCLayerRGBA_updateDisplayedColor_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("updateDisplayedOpacity", JSB_CCLayerRGBA_updateDisplayedOpacity_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FS_END
	};
	static JSFunctionSpec st_funcs[] = {
