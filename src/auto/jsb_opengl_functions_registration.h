...
* Generated by "generate_jsb.py -c opengl_jsb.ini" on 2013-02-12
* Script version: v0.6
*/
...
JS_DefineFunction(_cx, opengl, "shaderSource", JSB_glShaderSource, 4, JSPROP_READONLY | JSPROP_PERMANENT | JSPROP_ENUMERATE );
