...
* Generated by "generate_jsb.py -c opengl_jsb.ini" on 2013-02-11
* Script version: v0.6
*/
...
JS_DefineFunction(_cx, opengl, "compileShader", JSB_glCompileShader, 1, JSPROP_READONLY | JSPROP_PERMANENT | JSPROP_ENUMERATE );
...
JS_DefineFunction(_cx, opengl, "createProgram", JSB_glCreateProgram, 0, JSPROP_READONLY | JSPROP_PERMANENT | JSPROP_ENUMERATE );
JS_DefineFunction(_cx, opengl, "createShader", JSB_glCreateShader, 1, JSPROP_READONLY | JSPROP_PERMANENT | JSPROP_ENUMERATE );
