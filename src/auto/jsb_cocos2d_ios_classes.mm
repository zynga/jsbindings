...
* Generated by "generate_jsb.py -c cocos2d_jsb.ini" on 2013-02-15
* Script version: v0.6
*/
#import "jsb_config.h"
...
JSBool JSB_CCDirector_winSize(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	jsval ret_jsval = JSB_jsval_from_CGSize( cx, (CGSize)ret_val );
	JS_SET_RVAL(cx, vp, ret_jsval);
...
-(void) ccTouchesEnded:(NSSet*)touches withEvent:(UIEvent*)event 
{
	if (_jsObj) {
		...
		if (found == JS_TRUE) {
			...
			unsigned argc=2;
			jsval argv[2];
			argv[0] = JSB_jsval_from_NSSet( cx, touches );
			argv[1] = JSB_jsval_from_NSObject( cx, event );
...
JSBool JSB_CCLayerRGBA_color(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	jsval ret_jsval = JSB_jsval_from_ccColor3B( cx, (ccColor3B)ret_val );
	JS_SET_RVAL(cx, vp, ret_jsval);
...
void JSB_CCLayerRGBA_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("isCascadeColorEnabled", JSB_CCLayerRGBA_isCascadeColorEnabled, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("isCascadeOpacityEnabled", JSB_CCLayerRGBA_isCascadeOpacityEnabled, 0, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setCascadeColorEnabled", JSB_CCLayerRGBA_setCascadeColorEnabled_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
		JS_FN("setCascadeOpacityEnabled", JSB_CCLayerRGBA_setCascadeOpacityEnabled_, 1, JSPROP_PERMANENT | JSPROP_SHARED | JSPROP_ENUMERATE),
