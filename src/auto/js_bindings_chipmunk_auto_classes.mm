...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpConstraint)", obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpGrooveJoint)", obj);
	void *handle = JS_GetPrivate(obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpSimpleMotor)", obj);
	void *handle = JS_GetPrivate(obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpPivotJoint)", obj);
	void *handle = JS_GetPrivate(obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpPinJoint)", obj);
	void *handle = JS_GetPrivate(obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpSlideJoint)", obj);
	void *handle = JS_GetPrivate(obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpGearJoint)", obj);
	void *handle = JS_GetPrivate(obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpDampedRotarySpring)", obj);
	void *handle = JS_GetPrivate(obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpDampedSpring)", obj);
	void *handle = JS_GetPrivate(obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpRatchetJoint)", obj);
	void *handle = JS_GetPrivate(obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpRotaryLimitJoint)", obj);
	void *handle = JS_GetPrivate(obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpArbiter)", obj);
	void *handle = JS_GetPrivate(obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpShape)", obj);
	void *handle = JS_GetPrivate(obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpCircleShape)", obj);
	void *handle = JS_GetPrivate(obj);
...
{
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpPolyShape)", obj);
	void *handle = JS_GetPrivate(obj);
