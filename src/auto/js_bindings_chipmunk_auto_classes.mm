...
* Generated by "generate_js_bindings.py -c chipmunk_jsb.ini" on 2012-09-21
* Script version: v0.3
*/
...
// Destructor
void JSB_cpBoxShape_finalize(JSFreeOp *fop, JSObject *jsthis)
{
	struct jsb_c_proxy_s *proxy = jsb_get_c_proxy_for_jsobject(jsthis);
	CCLOGINFO(@"jsbindings: finalizing JS object %p (cpBoxShape), handle: %p", jsthis, proxy->handle);
