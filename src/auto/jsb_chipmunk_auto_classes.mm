...
* Generated by "generate_jsb.py -c chipmunk_jsb.ini" on 2013-02-19
* Script version: v0.6
*/
...
JSBool JSB_cpConstraint_getA(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	jsval ret_jsval = JSB_jsval_from_c_class( cx, ret_val, JSB_cpBody_object, JSB_cpBody_class, "cpBody" );
...
JSBool JSB_cpConstraint_getSpace(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	jsval ret_jsval = JSB_jsval_from_c_class( cx, ret_val, JSB_cpSpace_object, JSB_cpSpace_class, "cpSpace" );
	JS_SET_RVAL(cx, vp, ret_jsval);
...
JSBool JSB_cpGrooveJoint_getAnchr2(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	jsval ret_jsval = JSB_jsval_from_cpVect( cx, (cpVect)ret_val );
	JS_SET_RVAL(cx, vp, ret_jsval);
...
JSBool JSB_cpSpace_pointQueryFirst(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	jsval ret_jsval = JSB_jsval_from_c_class( cx, ret_val, JSB_cpShape_object, JSB_cpShape_class, "cpShape" );
	JS_SET_RVAL(cx, vp, ret_jsval);
...
JSBool JSB_cpShape_cacheBB(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	jsval ret_jsval = JSB_jsval_from_cpBB( cx, (cpBB)ret_val );
	JS_SET_RVAL(cx, vp, ret_jsval);
...
JSBool JSB_cpShape_getCollisionType(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	jsval ret_jsval = JSB_jsval_from_long( cx, (cpCollisionType)ret_val );
	JS_SET_RVAL(cx, vp, ret_jsval);
...
JSBool JSB_cpShape_getGroup(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	jsval ret_jsval = JSB_jsval_from_long( cx, (cpGroup)ret_val );
	JS_SET_RVAL(cx, vp, ret_jsval);
